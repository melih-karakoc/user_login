...
from .strategy_logics.social_logins import GitHubStrategy, GoogleStrategy
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if user:
                ...
                messages.success(
                    request, f'Account created for {username} please verify your email'
                )
...
class CustomLoginView(LoginView):
    ...
    def form_valid(self, form):
        ...
        if user.profile.is_email_verified is not True:
...
class SocialAuthView(View):
    provider_strategy_map = {'google': GoogleStrategy, 'gitHub': GitHubStrategy}
...
class SocialAuthCallback(SocialAuthView):
    def get(self, request):
        ...
        try:
            strategy().social_auth_callback(request)
        except Exception as e:
